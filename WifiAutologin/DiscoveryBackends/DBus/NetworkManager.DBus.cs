#pragma warning disable CS8625 // Generated code
...
namespace NetworkManager.DBus
{
    ...
    public enum DeviceType : uint
    {
        ...
        Dummy = 22,
        PPP = 23,
        Open_vSwitch_Interface = 24,
        Open_vSwitch_Port = 25,
        Open_vSwitch_Bridge = 26,
        WPAN = 27,
        // 6LoWPAN = 28,
        WireGuard = 29,
        WiFi_P2P = 30,
    ...
    static class DeviceExtensions
    {
        ...
        public static Task<DeviceType> GetDeviceTypeAsync(this IDevice o) => o.GetAsync<DeviceType>("DeviceType");
